...
_STRINGS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "error": "Error",
        "info": "Info",
        "theme_restart_needed": "Theme saved. Restart AstraEdit for it to take effect.",
        ...
        "sc_terminal": "Show the embedded terminal",
    ...
    "pl": {
        ...
        "error": "Błąd",
        "info": "Info",
        "theme_restart_needed": "Motyw zapisany. Zrestartuj AstraEdit, żeby zaczął działać.",
        ...
        "menu_language": "Język",
        "menu_theme": "Motyw",
        "menu_theme_dark": "Ciemny",
        "menu_theme_light": "Jasny",
        "menu_lang_en": "English",
        "menu_lang_pl": "Polski",
        "menu_help": "Pomoc",
        ...
        "sc_terminal": "Pokaż wbudowany terminal",
